          ...
          <div class="col-lg-6 col-md-12 col-6 mb-4">
            <div class="card">
              <div class="card-body">
                ...
                <span class="fw-medium d-block mb-1">Pemasukan Harian</span>
                <h3 class="card-title mb-2">Rp. {{ $hariini }}</h3>
          ...
          <div class="col-lg-6 col-md-12 col-6 mb-4">
            <div class="card">
              <div class="card-body">
                ...
                <h3 class="card-title text-nowrap mb-1">Rp. {{ $bulanini }}</h3>
          ...
          <div class="col-6 mb-4">
            <div class="card">
              <div class="card-body">
                ...
                <span class="fw-medium d-block mb-1">Pemasukan Tahunan</span>
                <h3 class="card-title mb-2">Rp. {{ $tahunini }}</h3>
