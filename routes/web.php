...
Route::post('/admin_kepala/akun_pegawai/tambah', [akunController::class,'tambah_pegawai'])->name('tambah_akun_pegawai');
...
Route::post('/admin_kepala/akun_apoteker/tambah', [akunController::class,'tambah_apoteker'])->name('tambah_akun_apoteker');
